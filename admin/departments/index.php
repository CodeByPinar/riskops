                ...
                <form method="post" action="<?= e(url('/admin/departments/save.php')) ?>" novalidate>
                    ...
                    <div class="rk-field">
                        ...
                        <input class="<?= e($cls('name', 'rk-input')) ?>" type="text" id="name" name="name"
                               ...
                               placeholder="<?= te('Örn: Bilgi Teknolojileri') ?>">
                        <?= $err('name') ?>
                    </div>
                    ...
                    <div class="rk-field">
                        ...
                        <input class="<?= e($cls('code', 'rk-input')) ?>" type="text" id="code" name="code"
                               ...
                               placeholder="<?= te('Örn: IT') ?>" class="rk-u-upper">
                        <?= $err('code') ?>
                        <div class="rk-help"><?= te('Kısa, benzersiz tanımlayıcı. Büyük harfe çevrilir.') ?></div>
                    </div>
                    ...
                    <div class="rk-field">
                        <label class="rk-label" for="manager_id"><?= te('Yönetici') ?></label>
