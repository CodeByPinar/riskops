        ...
        <div class="col-12 col-xl-8">
            <div class="rk-card">
                <div class="rk-card-head">
                    <h2 class="rk-card-title"><i class="bi bi-check2-square"></i> <?= te('Aksiyon') ?></h2>
                </div>
                <div class="rk-card-body">

                    <div class="rk-field">
                        <label class="rk-label" for="risk_id"><?= te('Bağlı Risk') ?> <span class="req">*</span></label>
                    ...
                    <div class="rk-field">
                        <label class="rk-label" for="title"><?= te('Aksiyon Başlığı') ?> <span class="req">*</span></label>
                        <input class="<?= e($cls('title', 'rk-input')) ?>" type="text" id="title" name="title"
                               maxlength="200" required value="<?= e($val('title')) ?>"
                               placeholder="<?= te('Örn: RDP erişimini VPN arkasına alma') ?>">
                        <?= $err('title') ?>
                    </div>
                    ...
                    <div class="rk-field">
                        ...
                        <textarea class="rk-textarea" id="description" name="description" rows="5"
                                  placeholder="<?= te('Yapılacak işin kapsamı, bağımlılıklar, kabul kriteri') ?>"><?= e($val('description')) ?></textarea>
                    </div>
        ...
        <div class="col-12 col-xl-4">
            <div class="rk-card">
                ...
                <div class="rk-card-body">
                    ...
                    <div class="rk-field">
                        <label class="rk-label" for="owner_id"><?= te('Sorumlu') ?> <span class="req">*</span></label>
                    ...
                    <div class="rk-field">
                        <label class="rk-label" for="priority"><?= te('Öncelik') ?> <span class="req">*</span></label>
                    ...
                    <div class="rk-field">
                        <label class="rk-label" for="due_date"><?= te('Termin') ?></label>
            ...
            <div class="rk-form-actions">
                ...
                <a class="rk-btn" href="<?= e($cancelUrl) ?>"><?= te('Vazgeç') ?></a>
            </div>
        </div>
    </div>
</form>
